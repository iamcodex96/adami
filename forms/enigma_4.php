...
<?php startblock('principal')?>
    <div class="container">
        <div class="card mx-auto mt-4 bg-transparent justify-content-center">
            <div id="fondo" class="center card-body">
                <div class="title">
                    <h3></h3>
                    <div class="row justify-content-center">
                        ...
                        <button class='btn-primary col-sm-auto mr-3 mb-2 mt-1' id="start" onclick="start(<?php echo $time ?>)"><?php echo $enigma_4['start']?></button>
                        <h3><?php echo $enigma_4['tiempo'].":"?></h3> 
                        <h3 class="col-sm-1" id=time><?php echo $time . "'" ?></h3>
        ...
        <div class="modal" tabindex="-1" role="dialog" id="over">
            <div class="modal-dialog" role="document">
                ...
                <a href="enigma_4.php"><button type="button" class="btn btn-danger"><?php echo $enigma_4['reintentar']?></button></a>
                </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content bg-purple">
                    ...
                    <div class="modal-footer text-white">
                        <a href="enigma_4.php"><button type="button" class="btn btn-secondary" id="btn_play_again"><?php echo $enigma_4['reintentar'] ?></button></a>
        ...
        <div class="modal fade" id="infoModal" tabindex="-1" role="dialog" aria-labelledby="instructModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content bg-purple">
                    <div class="modal-body text-justify text-white"><?php echo $historia['enigma4'] ?></div>
                    <div class="modal-footer text-white">
                        <button type="button" class="btn btn-success" id="btn_start"><?php echo $enigma_4['siguiente'] ?></button>
                    </div>
                </div>
            </div>
        </div>
...
<?php startblock('own_js_onload')?>
    ...
    <script src="<?php echo $rutas["lang_enigma_4_js"] ?>"></script>
<?php endblock() ?>